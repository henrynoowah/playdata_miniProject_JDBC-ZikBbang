...
public class RunningEndView {
	...
	public static void AppListView(ArrayList allApp) {
		if (allApp != null) {
			...
			if (length != 0) {
				...
				System.out.println("요청하신 프로젝트 정보는 없습니다");
			}
		} else {
	...
	public static void updateBuildingView(boolean result, String buildingId) {
		if (result == true) {
			System.out.println("요청하신 " + buildingId + "의 region, address, building_type 수정 완료");
		} else {
			System.out.println("요청하신 " + buildingId + " 수정 실패, id 재확인 하세요");
		}
	}
	...
	public static void updatePriceView(boolean result, String appId) {
		if (result == true) {
			System.out.println("요청하신 " + appId + "의 deposit, monthly_rent, trade_price 수정 완료");
		} else {
			System.out.println("요청하신 " + appId + " 수정 실패, id 재확인 하세요");
		}
	}
	...
	public static void updateSellerView(boolean result, String sellerId) {
		if (result == true) {
			System.out.println("요청하신 " + sellerId + "의 name, phone 수정 완료");
		} else {
			System.out.println("요청하신 " + sellerId + " 수정 실패, id 재확인 하세요");
		}
	}
	...
	public static void updateTradeTypeView(boolean result, String appId) {
		if (result == true) {
			System.out.println("요청하신 " + appId + "의 trade_type 수정 완료");
		} else {
			System.out.println("요청하신 " + appId + " 수정 실패, id 재확인 하세요");
		}
	}
	...
	public static void updateTenantView(boolean result, String appId) {
		if (result == true) {
			System.out.println("요청하신 " + appId + "의 tenant 수정 완료");
		} else {
			System.out.println("요청하신 " + appId + " 수정 실패, id 재확인 하세요");
		}
	}
	...
	public static void insertAppView(boolean result, String Id) {
		if (result == true) {
			System.out.println("요청하신 [App Id : " + Id + "] App insert 완료");
		} else {
			System.out.println("요청하신 [App Id : " + Id + "] App insert 실패, id 재확인 하세요");
		}
	}
	...
	public static void insertBuildingView(boolean result, String Id) {
		if (result == true) {
			System.out.println("요청하신 [Building Id : " + Id + "] Building insert 완료");
		} else {
			System.out.println("요청하신 [Building Id : " + Id + "] insert 실패, id 재확인 하세요");
		}
	}
	...
	public static void insertPriceView(boolean result, String Id) {
		if (result == true) {
			System.out.println("요청하신 [App id : " + Id + "] Price insert 완료");
		} else {
			System.out.println("요청하신 [App id : " + Id + "] insert 실패, id 재확인 하세요");
		}
	}
	...
	public static void insertSellerView(boolean result, String Id) {
		if (result == true) {
			System.out.println("요청하신 [Seller Id : " + Id + "] Seller insert 완료");
		} else {
			System.out.println("요청하신 [Seller Id : " + Id + "] Seller 실패, id 재확인 하세요");
		}
	}
	...
	public static void deleteAppView(boolean result, String Id) {
		if (result == true) {
			System.out.println("요청하신 [App Id : " + Id + "] App delete 완료");
		} else {
			System.out.println("요청하신 [App Id : " + Id + "] App delete 실패, id 재확인 하세요");
		}
	}
	
	// Building delete 성공, 실패시 메시지 출력 -
	public static void deleteBuildingView(boolean result, String Id) {
		if (result == true) {
			System.out.println("요청하신 [Building Id : " + Id + "] Building delete 완료");
		} else {
			System.out.println("요청하신 [Building Id : " + Id + "] Building delete 실패, id 재확인 하세요");
		}
	}
	
	// Price delete 성공, 실패시 메시지 출력 -
	public static void deletePriceView(boolean result, String Id) {
		if (result == true) {
			System.out.println("요청하신 [App id : " + Id + "] Price delete 완료");
		} else {
			System.out.println("요청하신 [App id : " + Id + "] Price delete 실패, id 재확인 하세요");
		}
	}
	...
	public static void deleteSellerView(boolean result, String Id) {
		if (result == true) {
			System.out.println("요청하신 [Seller Id : " + Id + "] Seller delete 완료");
		} else {
			System.out.println("요청하신 [Seller Id : " + Id + "] Seller delete 실패, id 재확인 하세요");
		}
	}
